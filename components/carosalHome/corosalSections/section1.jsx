...
function Section1() {
    return (
        <div className='h-auto grid grid-cols-1  md:grid-cols-2 lg:grid-cols-2 gap-4'>
            <aside className='flex items-center'>
                <article className='headerArticle'>
                    <h1 className='mainHead pb-2 text-dark-gray font-extra-bold font-2xl opacity-100'>Largest Software <br /> Training <br /> Organisation</h1>
