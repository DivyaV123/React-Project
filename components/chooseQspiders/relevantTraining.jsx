                ...
                <aside className='flex items-center'>
                    <div>
                        <header>
                            ...
                            <p id="tagline" className='text-[#454545] flex-col item-center fulljustify text-[1.406vw]  mt-[3.333vh] mobile:mt-[2.575vh] mobile:text-[4.186vw]'>
                        ...
                        <article className='flex justify-start align-start mt-[3.333vh] mobile:mt-[2.575vh]'>
                            <aside className='w-[100%]'>
                                ...
                                <p className='text-brown txet-normal text-[1.25vw] flex justify-center  text-center mobile:text-[3.721vw]'>Industry-relevant <br />technologies are offered</p>
                            </aside>
                            <aside className='w-[100%]'>
                                ...
                                <p className='text-brown text-normal text-[1.25vw] flex justify-center  text-center mobile:text-[3.721vw]'>Training Institutes <br /> all over India</p>
                            </aside>
                        </article>
                        <article className='flex justify-center mt-[3.333vh] mobile:mt-[2.575vh]'>
                            <Button
                                className='bg-gradient text-[1.25vw] text-white rounded w-[11.719vw] h-[3.75vw] mobile:h-[5.15vh] mobile:w-[31.628vw] mobile:text-[3.721vw]'
                                title="Enquire Now"
