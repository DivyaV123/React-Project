                    ...
                    <aside className='mt-[3.333vh] animate-slide-from-left'>
                        ...
                        <article className='flex justify-center align-center mt-[3.333vh] mobile:mt-[2.575vh]'>
                            <aside className='w-[100%]'>
                                ...
                                }} className='gradient-text font-extra-bold text-medium text-[1.875vw] mobile:text-[5.581vw] opacity-100 flex justify-center'>
                                    <Counter initialValue={0} targetValue={5000} label='2.5Lac+' /><br />
                                </h1>
                                <p className='text-brown text-normal text-[1.25vw] mobile:text-[3.721vw] flex justify-center  text-center'>Students Placed <br /> in Total</p>
                            </aside>
                            <aside className='w-[100%]'>
                                <h1 className='gradient-text mobile:text-[5.581vw] font-extra-bold text-[1.875vw] opacity-100 flex justify-center'>
                                    <Counter initialValue={0} targetValue={5000} label='4,100+' /><br />
                                </h1>
                                <p className='text-brown text-normal text-[1.25vw] flex justify-center mobile:text-[3.721vw]  text-center'>Multinational <br /> companies hire from us</p>
                            </aside>
                        </article>
                        <Link href={PLACEMENT_PATH}>
                            <article className='flex justify-center mobile:mt-[2.575vh]'>
                                <Button
                                    className='bg-gradient text-[1.25vw] text-white h-[3.75vw] rounded mt-8  w-[14.844vw] mobile:h-[5.15vh] mobile:w-[44.186vw]'
