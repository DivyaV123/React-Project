            ...
            <article className='sm:grid grid-cols-2 gap-4 mobile:flex mobile:flex-col-reverse'>
                <Fade left delay={0} duration={1000}>
                    <aside className='mt-6 animate-slide-from-left'>
                        ...
                        <p id="tagline tabView:choose_para_tab" className='text-dark-gray text-center text-[18px] mobile:text-[4.186vw] mt-6 mobile:mt-[2.575vh] tabView:text-[1.613vw]'>
                        ...
                        <article className='flex justify-center align-center mt-6 mobile:mt-[2.575vh]'>
                            <aside className='w-[100%]'>
                                ...
                                }} className='gradient-text font-extra-bold text-medium text-xl mobile:text-[5.581vw] opacity-100 flex justify-center tabView:text-[2.688vw]'>
                                    <Counter initialValue={0} targetValue={5000} label='2.5Lac+' /><br />
                                </h1>
                                <p className='text-brown text-normal mobile:text-[3.721vw] flex justify-center  text-center tabView:text-[1.882vw]'>Students Placed <br /> in Total</p>
                            </aside>
                            <aside className='w-[100%]'>
                                <h1 className='gradient-text mobile:text-[5.581vw] font-extra-bold text-xl opacity-100 flex justify-center tabView:text-[2.688vw]'>
                                    <Counter initialValue={0} targetValue={5000} label='4,100+' /><br />
                                </h1>
                                <p className='text-brown text-normal flex justify-center mobile:text-[3.721vw]  text-center tabView:text-[1.882vw]'>Multinational <br /> companies hire from us</p>
                            </aside>
                        </article>
                        <Link href={PLACEMENT_PATH}>
                            <article className='flex justify-center mobile:mt-[2.575vh]'>
                                <Button
                                    className='bg-gradient text-white h-[3.75vw] rounded mt-8  w-[14.844vw] mobile:h-[5.15vh] mobile:w-[44.186vw] tabView:px-5 tabView:py-4 tabView:flex tabView:items-center tabView:w-auto tabView:h-auto'
