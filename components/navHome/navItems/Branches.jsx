...
const Branches = ({ BranchResponse }) => {
  ...
  const finalContent =
    cityData[hoveredIndex]?.courses[hoveredItemIndex]?.branches;
    ...
    <div className="w-[81.09vw]  lg:h-[500px] overflow-auto myscrollbar">
      ...
      <div className="flex ">
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between grow">
                  <button className="p-2.5 text-sm">
                    {courseItem.cityName}
                  </button>
                  <img
        ...
        <div className="xl:w-[64.34vw] 2xl:w-[67.34vw] 3xl:w-[70.34vw] flex ">
          {hoveredIndex !== null &&
            cityData?.[hoveredIndex]?.courses?.length > 0 && (
            ...
            {finalContent?.length > 0 &&
              finalContent?.map((content, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="flex branchMenuCard bg-[#FFFFFF] xl:w-[19.922vw] 2xl:w-[22.73vw] 3xl:w-[25.2vw]  rounded-xl px-[1.389vh] py-[0.781vw]"
                      key={index}
                      onClick={() =>
                    ...
                    >
                      ...
                      <div className="pl-[0.781vw]">
                        <div className="flex justify-between pb-[1.111vh]">
                          ...
                          <button
                            onClick={() =>
                              window.open(content.location, "_blank")
                            }
                            className="flex gap-1 text-xs text z-1 items-center"
                          >
                            <p className="text-[#7298FF] text-[0.703vw] p-[0.156vw]">
                              Get Directions
                            </p>
                            <img
                        ...
                        <div className="flex pb-[0.556vh] 3xl:items-center 3xl:gap-4">
                          <div className="flex gap-1.5 justify-center">
                            ...
                            <p className="text-[0.781vw]">
                              {content.upcomingBatches} Upcoming Batches
                            </p>
                          </div>
                          <div className="flex gap-1.5 justify-center">
                            <Svg
                            ...
                            />
                            <p className="text-[0.781vw] pl-[0.469vw]">
                              {content.ongoingBatches} Ongoing Batches
                            </p>
                          </div>
                        </div>
                      </div>
