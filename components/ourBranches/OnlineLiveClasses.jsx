            ...
            >
              ...
              <div className="flex pb-[1.389vh] gap-y-[0.469vw] items-center  justify-between">
                <div className={`${dateAndTime}`}>
                  ...
                  />
                  <div>{batch.date ? batch.date : `${convertDate(batch.startingDate)}-${convertDate(batch.endingDate)}`}</div>
                </div>
                <div className={`${dateAndTime}`}>
                  <Svg
                  ...
                  />
                  <div>{batch.time ? batch.time : `${convertToIST(batch.startingTime)}-${convertToIST(batch.endingTime)}`}</div>
                </div>
              </div>
              <div className={`${dateAndTime} pb-[1.389vh]`}>
                ...
                />
                <div>{batch.place ? batch.place : branchName}</div>
              </div>
              <div className={`${dateAndTime} pb-[1.389vh]`}>
                <Svg
                  className=" pr-[0.469vw]"
                  ...
                  color={svgicons.calender[4]}
                />
                <div>{batch.day ? batch.day : batch.batchType}</div>
              </div>
