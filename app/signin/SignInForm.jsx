...
function SignInForm() {
    ...
    return (
        <section className='w-[34.375vw] border bg-white rounded-xl sm:pt-[3.611vh] sm:px-[1.875vw] sm:pb-[4.444vh] mobile:w-full mobile:mt-[5.556vh] mobile:mb-[9.227vh] mobile:px-[5.581vw] mobile:pt-[3.433vh] mobile:pb-[3.433vh]'>
            <header>
                <h1 className='font-bold text-dark-gray text-[1.875vw] border-s-4 border-orange-500 rounded pl-[0.625vw] mobile:text-[5.581vw] mobile:pl-[2.791vw]'>
                    Sign In
                </h1>
                <form className='mt-[4.444vh] mobile:mt-[3.433vh]' onSubmit={formik.handleSubmit}>
                    <div className='mb-[3.333vh] mobile:mb-[1.717vh]'>
                        <div className='font-semibold text-dark-gray pb-[1.389vh] mobile:pb-[1.073vh] mobile:text-[3.721vw]'>Email/ Mobile</div>
                        <Input
                    ...
                    <div className='mb-[3.333vh] mobile:mb-[0vh]'>
                        <div className='font-semibold text-dark-gray pb-[1.389vh] mobile:pb-[1.073vh] mobile:text-[3.721vw]'>Password</div>
                        <Input
                            name='password'
                            type='password'
                            inputStyle='w-full text-[#A8A8A8] text-[0.938vw] h-[6.667vh] outline-none mobile:h-[5.15vh] mobile:text-[2.791vw]'
                    ...
                    <Button
                        ...
                        className='w-full py-[1.667vh] px-[1.875vw] rounded-md text-white bg-gradient mobile:px-[5.581vw] mobile:py-[1.288vh] mobile:mt-[3.433vh]'
                        title=' Sign In'
                    />
                    <p className='text-[0.938vw] flex justify-center mt-[16.111vh] items-end gap-1 mobile:mt-[12.446vh] mobile:text-[2.791vw]'>
