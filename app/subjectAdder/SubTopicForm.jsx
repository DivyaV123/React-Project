  ...
  return (
        ...
        <div className='m-auto border mt-4 mb-4 border-gray-300 p-8 rounded-xl'>
          <form onSubmit={formik.handleSubmit}>
            <div>
              <label><span className="text-red-500 pr-1 ">*</span> SubTopic Name</label>
              <Input
                type="text"
                name="subTopicTitle"
              ...
              />
              {formik.errors.subTopicTitle ? <div>{formik.errors.subTopicTitle}</div> : null}
            </div>
            <div>
              <label>URL</label>
              <Input
              ...
              />
              {formik.errors.subTopicPreviewUrl ? <div>{formik.errors.subTopicPreviewUrl}</div> : null}
            </div>
            <div>
            ...
            onBlur={formik.handleBlur}
              ...
              />
              {formik.errors.subTopicPreviewDuration ? <div>{formik.errors.subTopicPreviewDuration}</div> : null}
            </div>
