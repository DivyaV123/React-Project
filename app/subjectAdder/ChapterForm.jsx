  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <div className="mb-2">
        <label>
          {" "}
          <span className="text-red-500 pr-1 ">*</span>Chapter Name
        </label>
        <Input
          type="text"
          name="chapterTitle"
      ...
      <div className="mb-2">
        ...
        />
        {formik.errors.chapterPreviewUrl ? (
          <div>{formik.errors.chapterPreviewUrl}</div>
        ) : null}
      </div>
      <div className="mb-2">
        ...
        />
        {formik.errors.chapterPreviewDuration ? (
          <div>{formik.errors.chapterPreviewDuration}</div>
        ) : null}
      </div>
      {topics.map((topic, index) => (
        <TopicForm
          ...
          onUpdateTopic={(updatedTopic) =>
            handleUpdateTopic(updatedTopic, index)
          }
        />
      ))}
      <button
