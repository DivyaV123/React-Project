        ...
        <CoursePageContainer className={page === 'branch' ? '!w-full !p-0' : 'bg-[#F9F9F9]'}>
            <article className=''>
                ...
                <Link href={PLACEMENT_PATH}>
                    <article className={page === "branch" ? 'flex justify-center mt-[4.444vh] sm:pb-[4.444vh] mobile:mt-[1.824vh] mobile:mb-[3.112vh]' : 'flex justify-center mt-[2.778vh] w-[51.56vw] pb-[2.778vh]'}>
                        <Button
