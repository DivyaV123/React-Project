...
const PlacementSideBar = ({
  ...
  const [clearDropdownPlaceholder, setClearDropdownPlaceholder] =
    useState(false);
  ...
  const getSideBarTitleFromTimePeriod = (timePeriod) => {
    if (!timePeriod) return "Last week";
  ...
  return (
    <AlertDialog popup="filterPopup">
      <section className="block mobile:flex-col sm:ml-[1.875vw] sm:mb-[1.111vh] h-[58.889vh]">
        {isLoading ? (
          <>
          ...
          <div className="flex h-[90vh] max-h-[100vh]">
            <aside className="sidebarContainer  sm:pt-[3.333vh] mobile:ml-[3.721vw] mobile:items-center">
              <div className="mobile:w-[68.372vw] mobile:flex items-center">
                {sideBar.map((classItem, index) => (
                  <button
                    key={index}
                    className={`flex  h-[11.889vh]  justify-center text-[1.15vw] items-center mobileRadius px-[1.25vw] py-[2.222vh] mobile:py-[0.429vh] mobile:px-[3.256vw]  sm:w-full  mobile:text-[3.256vw] mobile:hidden ${
                    ...
                    onClick={() => {
                      handlePlacementCommonFilter(classItem.title);
                      scrollToBottom();
                      setClearDropdownPlaceholder(true);
                    }}
                  >
                    <div>
                      <span
                        className={`flex text-[#B9357C] font-semibold justify-center h-[4.444vh] text-[1.25vw] items-center mobileRadius px-[1.25vw] py-[2.222vh] mobile:py-[0.429vh] mobile:px-[3.256vw] mb-[0.833vh] sm:w-full  mobile:text-[3.256vw] mobile:hidden ${
                          classItem.title === sideBarBtn &&
                          !lesscheckedIcon &&
                          !throughcheckedIcon &&
                          !itCheckedIcon &&
            ...
            <Degree_Branch_Passout
              ...
              clearDropdownPlaceholder={clearDropdownPlaceholder}
            />
          </div>
        )}
